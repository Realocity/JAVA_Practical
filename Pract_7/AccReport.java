...
//		Accept data of 10 account holders.
		...
		acc.setAcc_Account(1, "Current", "Ganesh", 22000);
		listAcc.add(acc);

		acc = new Account();
		acc.setAcc_Account(2, "Saving", "Rahul", 9000);
		listAcc.add(acc);

		acc = new Account();
		acc.setAcc_Account(3, "Saving", "Prajyot", 17400);
		listAcc.add(acc);

		acc = new Account();
		acc.setAcc_Account(4, "Saving", "Akshay", 89000);
		listAcc.add(acc);

		acc = new Account();
		acc.setAcc_Account(5, "Current", "Shyam", 122);
		listAcc.add(acc);

		acc = new Account();
		acc.setAcc_Account(6, "Saving", "Amol", 1800);
		listAcc.add(acc);
		...
		acc = new Account();
		acc.setAcc_Account(8, "Saving", "Swapnil", 4000);
		listAcc.add(acc);

		acc = new Account();
		acc.setAcc_Account(9, "Saving", "Manoj", 8200);
		listAcc.add(acc);

		acc = new Account();
		acc.setAcc_Account(10, "Saving", "Devan", 43000);
		listAcc.add(acc);
